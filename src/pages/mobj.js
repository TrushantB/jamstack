  ...
  return (
    <div className='container'>
      ...
      <div className="mb-32 flex flex-col items-center">
        <h2 className="text-center pb-5">What is mobj?</h2>
        <p className='w-7/12 mx-auto text-center'>The mobj is an innovation of Jamstack+ based on JAMstack architecture.
...
<img
        ...
        <h2 className="text-center text-4xl">mobj Process</h2>
      </div>
     ...
     <div className="py-32 border-t-2 border-b-2 border-red-600">
      ...
      <div className="flex fle-col bg-accent-100 justify-center items-center">
        <h2 className="text-4xl py-20 ">Excited to switch to mobj?</h2>
      </div>
