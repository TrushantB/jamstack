...
export default function privacyPolicy({ header, footer }) {
  ...
  <li>
  <p><strong>Company</strong>&nbsp;(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Setoo PVT LTD, Pune, Maharashtra.</p>
  </li>
  <li>
  ...
  <li>
  <p><strong>Website</strong>&nbsp;refers to Jamstack+, accessible from jamstack.plus</p>
  </li>
  <li>
  ...
  <h2><strong>Tracking Technologies and Cookies</strong></h2>
  <p>&nbsp;</p>
  ...
  <h2><strong>Necessary / Essential Cookies</strong></h2>
  <p>&nbsp;</p>
  <ul>
  <li>
  ...
  <ul>
  <li>
  <p>By email:&nbsp;hello@jamstack.plus</p>
  </li>
  </ul>`;
