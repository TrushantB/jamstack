  ...
  return (
    <div className="container">
      ...
      <div className="border-t-2 border-b-2 pb-32 border-blue-600">
        ...
        <div className="lg:w-7/12 flex justify-center items-center text-4xl">Card section</div>
        </div>
      ...
      <div className="flex fle-col bg-accent-100 ">
        <h2 className="text-4xl py-20 lg:w-6/12  lg:pl-24">Jamstack is the way to sustainable success and Jamstack+ is your gateway.</h2>
      </div>
