    ...
    <div className="container">
      ...
      <div className="bg-secondary text-white lg:pl-28 lg:py-16">
       ...
       <div className="border-t-2 border-b-2 border-red-600 pb-32 lg:pl-24">
        ...
        <p className="w-5/12">Not sure what will work for you. Connect with Jamstack+ and know how can we help you improve your business.</p>
       ...
       <div className="border-t-2 border-b-2 border-blue-600 ">
        <h3 className="text-4xl text-center mb-32">Footer section</h3>
      </div>
