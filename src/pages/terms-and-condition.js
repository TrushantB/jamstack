...
export default function termsAndCondition({ header, footer }) {
  ...
  <p>These terms and conditions outline the rules and regulations for the use of Jamstack+'s Website, located at Setoo PVT LTD</p>
  ...
  <p>&nbsp;</p>
  <p>We employ the use of cookies. By accessing Jamstack+, you agreed to use cookies in agreement with the Jamstack+ Privacy Policy.</p>
  ...
  <p>&nbsp;</p>
  <p>Unless otherwise stated, Jamstack+ and/or its licensors own the intellectual property rights for all material on Jamstack+. All intellectual property rights are reserved. You may access this from Jamstack+ for your own personal use subjected to restrictions set in these terms and conditions.</p>
  <p>You must not:</p>
  <ul>
  <li>
  <p>Republish material from Jamstack+</p>
  </li>
  <li>
  <p>Sell, rent or sub-license material from Jamstack+</p>
  </li>
  <li>
  <p>Reproduce, duplicate or copy material from Jamstack+</p>
  </li>
  <li>
  <p>Redistribute content from Jamstack+</p>
  </li>
  </ul>
  <p>This Agreement shall begin on the date hereof.</p>
  <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Jamstack+ does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Jamstack+,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Jamstack+ shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>
  <p>Jamstack+ reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
  ...
  <p>You hereby grant Jamstack+ a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
  ...
  <li>
  <p><a href="http://dot.com">dot.com</a> community sites;</p>
  </li>
  <li>
  ...
  <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Jamstack+; and (d) the link is in the context of general resource information.</p>
  ...
  <p>No use of Jamstack+ logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
