  ...
  return (
    <>
      <footer className="container lg:mx-auto mt-7">
        <div className="grid grid-cols-12  mx-4 lg:mx-0">
          ...
          <div className="col-span-12 sm:col-span-5 mt-5 sm:mt-0  mx-4 lg:mx-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 sm:py-5 lg:py-10 mt-5 sm:mt-0 mx-4 lg:mx-0">
