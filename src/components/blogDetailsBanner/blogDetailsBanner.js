  ...
  return (
    <>
      <div className="max-w-3xl mx-auto px-3 py-6 mt-3">
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
              <div class="flex items-center">
                ...
                <span class="ml-1 text-xs font-medium text-gray-500 md:ml-2 dark:text-gray-400 truncate max-w-[20ch] md:max-w-none">
                  {blogData?.heading}
                </span>
              </div>
            </li>
        ...
        {/* BreadCrumb ::end */}
        <div className="mb-4">
          <h1 className="lg:w-full">{blogData?.heading}</h1>
        </div>
        <div className="flex flex-wrap items-start gap-3 md:gap-8 mb-10">
          {blogData?.author?.name && (
            <div className="flex flex-col items-start md:justify-center gap-2">
              ...
              <a
                href="#"
                className="flex items-center gap-2 hover:text-primary transition ease-in delay-50 font-medium text-sm"
              >
                <img
                  className="w-6 h-6 object-cover object-center rounded-full ring ring-offset-2 ring-gray-100 dark:ring-gray-500"
                  src={blogData?.author?.image}
                  alt={blogData?.author?.alt}
                />
        ...
        <div>
          <img
            className="w-full h-auto max-h-[780px] rounded-3xl"
